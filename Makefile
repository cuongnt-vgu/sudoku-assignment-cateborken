CC = gcc
FLAGS = -ggdb3 -Wall -Wextra -Wshadow -std=gnu11 -Wno-unused-parameter -Wno-unused-but-set-variable -Werror -g
...
OBJS = src/hidden_singles.o src/naked_pairs.o src/naked_triples.o src/hidden_pairs.o src/hidden_triples.o src/utils.o
